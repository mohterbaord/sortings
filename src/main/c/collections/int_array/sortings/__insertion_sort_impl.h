...
__pure__ static struct __InsertionSortRun __init_insertion_sort_run(int right_elem_index_swapping);
__pure__ static bool __has_further_swapping(struct __InsertionSortRun insertion_sort_run);
__pure__ static int __left_elem_index_swapping_with_offset(struct __InsertionSortRun insertion_sort_run);
__pure__ static int __right_elem_index_swapping_with_offset(struct __InsertionSortRun insertion_sort_run);
__pure__ static struct __InsertionSortRun __next_insertion_sort_run(struct __InsertionSortRun insertion_sort_run);
static void __decide_swap_for_run(struct __InsertionSortRun* insertion_sort_run, IntArray* int_array);
...
static void __run_insertion_sort_for_index(IntArray* self, int index_to_swap_from) {
    typedef struct __InsertionSortRun InsertionSortRun;
    for (
...
__pure__ static struct __InsertionSortRun __init_insertion_sort_run(int right_elem_index_swapping) {
    struct __InsertionSortRun insertion_sort_run = {
...
__pure__ static struct __InsertionSortRun __next_insertion_sort_run(struct __InsertionSortRun insertion_sort_run) {
    struct __InsertionSortRun insertion_sort_run_next = {
